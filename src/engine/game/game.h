...
namespace engine::game
{
    ...
    class Game
    {
      ...
      private:
         ...
         */
        void makeCapture(const game::Move& move, const core::Color enemyColor) noexcept;
         ...
         */
        void makeEnPassant(const game::Move& move, const core::Color enemyColor) noexcept;
